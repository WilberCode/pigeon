...
if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){
	...
	foreach($_SESSION["products"] as $product){ //Print each item, quantity and price.
		...
		$cart_box 		.=  "<li> $product_id &ndash;  $product_name (Qty : $product_qty ) <span> $currency. $item_price </span></li>";
	...
	if(isset($_POST['correo'])){ 
		...
		$headers .= 'From: Pigeon Latam <suscriptores@pigeonlatam.com>'."\r\n";

		$destino = $correo;
		$asunto = "¡Hola! Gracias por suscribirte al Club Pigeon"; 
		...
		';
		//	$mensaje = file_get_contents('./bienvenida.php', true);
