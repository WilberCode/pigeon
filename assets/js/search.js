...
var gTag = function gTag() {
  if (window.location.hostname == 'pigeonlatam.com') {
    setTimeout(function () {
...
$(window).on('load', function () {
  ...
  $("#shopping-cart-results").on('click', 'a.remove-item', function (e) {
    ...
    $("#product-".concat(pcode, "  span")).replaceWith('   <button class="border-2 border-white border-solid bg-transparent px-2 py-1 leading-8 text-middle " type="submit">Elegir</button>');
  });
  $("#shopping-cart-results").on('click', 'button.register-from-cart', function (e) {
    e.preventDefault();
    $('#formlista-modal-wrap').toggleClass('formlista-modal-wrap-active');
    $('html, body').css({
      overflow: 'hidden',
