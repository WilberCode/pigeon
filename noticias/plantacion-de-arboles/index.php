    ...
    <div id="l-wrap">
        ...
        <main id="l-content" class="u-box-content-wrap">
            ...
            <div class="u-box-fixed">
                <p class="u-box-image">
                    <img src="/noticias/files/images/p_tree_planting_main.jpg" alt="">
                </p>
            </div>
            ...
            <div class="u-box-fixed"> 
                <div class="u-box-content">
                    ...
                    <div class="bgwhite">
                        ...
                        <ul class="pholist">
                            <li>
                                <p><img src="/noticias/files/images/tree_01.jpg" alt=""></p>
                            </li>
                            <li>
                                <p><img src="/noticias/files/images/tree_02.jpg" alt=""></p>
                            </li>
                        </ul>
...
Hoy en día, Miwa no Mori alberga un bosque de más de 150,000 robles, castaños y otros árboles de hoja ancha. También se ha convertido en un hogar para animales, como ranas, lochas y efímeras. En junio y julio también se pueden ver enjambres de luciérnagas. A través de esta iniciativa, estamos creando un bosque que permanecerá en el futuro de nuestros hijos.
                        ...
                        <ul class="pholist">
                            <li>
                                <p><img src="/noticias/files/images/tree_03.jpg" alt=""></p>
                            </li>
                            <li>
                                <p><img src="/noticias/files/images/tree_04.jpg" alt=""></p>
                            </li>
                        </ul>
                        ...
                        <ul class="pholist2">
                            <li>
                                <p><img src="/noticias/files/images/tree_06.jpg" alt=""></p>
                            </li>
                            <li>
                                <p><img src="/noticias/files/images/tree_07.jpg" alt=""></p>
                            </li>
                            <li>
                                <p><img src="/noticias/files/images/tree_08.jpg" alt=""></p>
                            </li>
                        </ul>
                    ...
                    <div class="sdgs_icon_list">
                        <ul>
                            <li><img src="/noticias/files/images/icon15.png" alt="" width="100%"></li>
                            <li><img src="/noticias/files/images/icon17.png" alt="" width="100%"></li>
                        </ul>
                    </div>
                    ...
                    <ul class="pager-list">
                        <li class="list-item item-prev">
                            <a href="/noticias/enfermeria/" class="item-inner ">
                                ...
                                <span class="item-nav">Anterior</span>
                            </a>
                        </li>
