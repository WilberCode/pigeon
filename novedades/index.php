...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/unique/news.css?v=2">
</head>
...
<body id="top" class="is-wave ready ">
    ...
    <div id="l-wrap">
        ...
        <!-- [ CONTENT ] -->
        <main id="l-content">
            <div class="m-txt-ttl ttl-img ttl-img-news"
                style="background-image: url(/assets/images/news/p_news_mainv_pc.jpg)">
                <div data-fixed="" style="background-image: url(/assets/images/news/p_news_mainv_sp.jpg)">
                    <div class="ttl-inner">
                        <h1 class="ttl-txt">NOVEDADES</h1>
                    </div>
                </div>
            </div>
            <form action="" method="get" class="" data-fs="" data-fs-path="/news/data.json">
                        ...
                        <ul class="filter-list">
                            <li class="list-item item-category">
                                <div class="item-inner">
                                    ...
                                    <div class="item-select item-pc-hidden">
                                        <div class="m-form-select">
                                            <select name="category_filter" data-news-select-submit="">
    ...
    <script src="/assets/js/lib/flexibleSearch.js"></script>
