			...
			<div class=" px-4 py-18 lg:px-0 max-w-lg m-auto " >  
					<div class="content-main"> 
						<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2  "> 
							<a href="biberones_y_tetinas"  class="product-card" >
								<figure  class="block m-0 " >
									<img  class="w-full" src="/productos/files/images/Biberones_y_Tetinas.jpg" alt="Biberones y Tetinas">
								</figure>
								<div  class="product-card-body " >
									<h3>Biberones y Tetinas</h3>
								</div>
							</a>
							<a href="/productos/lactancia_materna/"  class="product-card" >
								<figure  class="block m-0 " >
									<img  class="w-full" src="/productos/files/images/Lactancia_Materna.jpg" alt="Lactancia Materna">
								</figure>
								<div  class="product-card-body " >
									<h3>Lactancia Materna</h3>
								</div>
							</a>
							<a href="/productos/destete/"  class="product-card" >
								<figure  class="block m-0 " >
							...
							<a href="/productos/limpieza_y_esterilizacion/"  class="product-card" >
								<figure  class="block m-0 " >
									<img  class="w-full" src="/productos/files/images/Limpieza_y_Esterilizacion.jpg" alt="Limpieza y Esterilización">
								</figure>
								<div  class="product-card-body " >
									<h3>Limpieza y Esterilización</h3>
								</div>
							</a>
							<a href="/productos/consuelos_y_mordedores/"  class="product-card" >
								<figure  class="block m-0 " >
									<img  class="w-full" src="/productos/files/images/Consuelos_y_Mordedores.jpg" alt="Consuelos y Mordedores">
								</figure>
								<div  class="product-card-body " >
									<h3>Consuelos y Mordedores</h3>
								</div>
							</a>
							<a href="/productos/cuidado_del_bebe/"  class="product-card" >
								<figure  class="block m-0 " >
									<img  class="w-full" src="/productos/files/images/Cuidado_del_Bebe.jpg" alt="Cuidado del Bebé">
								</figure>
								<div  class="product-card-body " >
									<h3>Cuidado del Bebé</h3>
								</div>
							</a>
							<a href="salud"  class="product-card" >
								<figure  class="block m-0 " >
