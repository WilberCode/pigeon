<header id="l-header" class="l-reset is-fadeout">
    ...
    <div class="headernav-sp" data-header-area-sp>
        ...
        <div class="sp-navs">
            <ul class="navs-tabs">
                <li><a href="/sobre/lared/" class="tabs-btn btn-region" rel="noopener">Global</a></li>
            ...
            <ul class="navs-list">
                <li>
                    ...
                    <ul>
                        <li><a href="/sobre/"><span class="link-inner">Sobre Pigeon</span></a></li>
                ...
                <li> 
                  <button class="list-sub" data-header-hassub-sp><span class="sub-inner">Sostenibilidad </span></button>
							<ul>
								...
								<li><a href="/noticias/plantacion-de-arboles/"><span class="link-inner">Conmemoración del nacimiento de bebés</span></a></li>
								<li><a href="/noticias/enfermeria/"><span class="link-inner">Establecimientos y Apoyos de Salones de Lactancia</span></a></li>
								<li><a href="/noticias/calentamiento/"><span class="link-inner">Cambio Climático y Biodiversidad</span></a></li> 
								<li><a href="/noticias/calentamiento/"><span class="link-inner">Cambio Climático y Biodiversidad</span></a></li> 
								<li><a href="/noticias/"><span class="link-inner">Disfruta a los bebés en plena acción</span></a></li> 
							</ul>  
                </li> 
    ...
    <div class="header-pc">
        <div class="pc-inner">
            ...
            <div class="inner-icons">
                <ul> 
                    <li><a href="/sobre/lared/" class="icons-btn icon-region" rel="noopener"><span
        ...
        <div class="pc-megamenu" data-header-subarea-pc="about">
            <div class="megamenu-area">
                ...
                <div class="area-menu is-pickup">
                    <dl>
                        <dt><a href="/sobre/"> Sobre Pigeon</a></dt>
                        <div class="menu-wrap">
                            <dd class="menu-inner">
                                <ul>
                                ...
                                <ul class="pickup-list">
                                    <li class="list-item">
                                        <a href="https://www.youtube.com/embed/o_H03ycRyM4?rel=0" class="item-inner"
                                            ...
                                            <p class="item-img"><img src="/assets/images/top/b_bnr_gnav_01.jpg" alt="Vídeo Corporativo">
                                            </p>
                                    ...
                                    <li class="list-item">
                                        <a href="https://www.youtube.com/embed/NuFxa_m55KY?rel=0" class="item-inner"
                                            data-modal="youtube" target="_blank" rel="noopener">
                                            <p class="item-img"><img src="/assets/images/top/b_bnr_gnav_02.jpg" alt="Marca Pigeon">
                                            </p>
        ...
        <div class="pc-megamenu" data-header-subarea-pc="sustainability">
            <div class="megamenu-area">
                ...
                <div class="area-menu is-pickup">
                    <dl>
                        <dt><a href="/sostenibilidad/">Sostenibilidad</a></dt>
                        <div class="menu-wrap">
                           <dd class="menu-inner">
										<ul>
											<li><a href="/noticias/calentamiento/">Cambio Climático y Biodiversidad</a></li>
											<li><a href="/noticias/plantacion-de-arboles/">Conmemoración del nacimiento de bebés</a></li>
									...
									<dd class="menu-pickup">
										<ul class="pickup-list">
											<li class="list-item">
												<a href="/noticias/" class="item-inner">
