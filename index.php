...
<head>
	...
	<meta name="keywords" content="Lactancia, Semana de la Lactancia, Lactancia Materna,para bebés,cosas para bebes,biberones,leche materna,lactancia es, biberones pigeon, Pigeon Bebé, Propósito Pigeon, Promesa Pigeon, Historia Pigeon,Biberones Pigeon,Tetinas Pigeon, chupete bebe Pigeon, Productos Pigeon,Cuidado del bebé Pigeon,Esencia Pigeon, Sostenibilidad Pigeon, Destete Pigeon, Limpieza y Esterilización Pigeon, Consuelos y Mordedores Pigeon, Cuidado del Bebé Pigeon, Salud Pigeon, contactos de tiendas Pigeon,Pigeon Bolivia, Pigeon Chile,Pigeon Colombia, Pigeon Costa Rica, Pigeon Guatemala, Pigeon Ecuador, Pigeon México, Pigeon Panamá, Pigeon Perú">
	<meta name="viewport" content="width=device-width,initial-scale=1">
	<meta name="format-detection" content="telephone=no">
	<link rel="canonical" href="<?=theCurrentUrl();?>" />
	<meta name="description" content="Descubre el propósito, promesa e historia sobre Pigeon, y encuentra productos de alta calidad✔️ para el cuidado del bebé y la lactancia materna. Ver tiendas disponibles en Latinoamérica… ">
...
<body id="top" class="is-wave">
	...
	<div id="l-wrap">
		...
		<!-- [ /GLOBAL HEADER ] -->
		<!-- [ CONTENT ] -->
		<main id="l-content" style="background: white;">
			<div class="u-top-loading-fade">
				<div class="loading-pre"></div>
				<div class="loading-bg"></div>
			</div>
			<div class="u-box-mainv_sp" data-mainv-sp>
				<div class="mainv-slider">
					<div class="swiper-container" data-top-mainv>
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<div class="slide-inner">
									<p class="slide-img"><img src="/assets/images/top/p_opening_en_sp.jpg"
											alt="Celebra a las bebés como son"></p>
									<!-- <a href="link.html" class="slide-link"><span class="btn-inner">Detail</span></a> -->
								</div>
							</div> 
						</div>
					</div>
								...
								<li class="list-item">
									<div class="item-wrap" data-mainv-item> 
										...
										<div class="item-body" data-mainv-body>
											<div class="body-desc">
												<p class="desc-p">
													<span class="p-dib">Queremos hacer el mundo más amigable para los
														bebés reforzando nuestro compromiso <br> de comprender y
														solucionar las necesidades únicas de los bebés.</span><br>
												</p>
											</div>
										</div>
									</div>
								...
								<li class="list-item">
									<div class="item-wrap" data-mainv-item>
										...
										<div class="item-body" data-mainv-body>
											<div class="body-desc">
												<p class="desc-p">
													<span class="p-dib"> Cada bebé nace con un don extraordinario: La
														capacidad de ser verdaderamente ellos mismos.
														Pigeon cree en preservar y alimentar las cualidades que hacen
														que cada bebé sea especial. Nuestros años de experiencia con
														varias generaciones de bebés nos han enseñado que no existe un
			...
			<div class="u-top-action">
				<div data-fixed-max>
					...
					<div class="action-sp">
						<div class="swiper-container action-slider-bg" data-top-actionbg-sp>
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<img src="/assets/images/home/bg_noticias_latam_v2_sp.jpg" alt="Establecimiento y Apoyo de Salones de Lactancia" class="slide-img">
								</div>
								<div class="swiper-slide">
									<img src="/assets/images/home/bg_noticias_latam_v2_sp.jpg" alt="Conmemoración del nacimiento de bebés"
										class="slide-img">
								</div>
							<!-- 	<div class="swiper-slide">
					...
					<div class="action-pc">
						<div class="swiper-container action-slider-bg" data-top-actionbg-pc>
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<img src="/assets/images/home/bg_noticias_latam_v2.jpg" alt="Establecimientos y Apoyos de Salones de Lactancia - pc" class="slide-img">
								</div>
								<div class="swiper-slide">
									<img src="/assets/images/home/bg_noticias_latam_v2.jpg" alt="Conmemoración del nacimiento de bebés - pc" class="slide-img">
								</div>
								<!-- <div class="swiper-slide">
					...
					<!-- <div class="action-btn">
						<a href="/celebrate/"><span class="btn-inner">Ver todo</span></a>
					</div> -->
				</div>
			</div>
			<div class="u-menu">
				<div data-fixed-max="">
					<div data-fixed="">
						<ul class="u-list-menu">
							<li class="menu-inner">
								<a href="/sobre/" class="menu-item about">
									<div class="item-wrap">
										<p class="item-text">Sobre Pigeon</p>
									</div>
								</a>
							</li>
							<li class="menu-inner">
								<a href="/sobre/esenciapigeon/" class="menu-item way">
									<div class="item-wrap">
							...
							<li class="menu-inner">
								<a href="/sostenibilidad/" class="menu-item esg">
									<div class="item-wrap">
										<p class="item-text">Sostenibilidad</p>
									</div>
								</a>
							</li>
							<li class="menu-inner">
								<a href="/sobre/historia/" class="menu-item  ir"  > 
									<div class="item-wrap">  
			...
			<div class="u-top-pickup">
				...
				<div class="pickup-slider">
					...
					<button class="ctrl-button prev" data-top-pickupprv>
						<span class="button-txt">prev</span>
						<span class="button-svg"></span>
					</button>
					<button class="ctrl-button next" data-top-pickupnxt>
			...
			<div class="u-top-map">
				...
				<div class="map-bg" data-top-map="">
					<div class="map-area">
						...
						<a href="/sobre/lared/?cat=001" class="map-btn btn-04" data-top-mapbtn="04">Europa</a>
						<a href="/sobre/lared/?cat=003" class="map-btn btn-05" data-top-mapbtn="05">Africa</a>
						<a href="/sobre/lared/?cat=006" class="map-btn btn-06" data-top-mapbtn="06">Latinoamérica</a> 
					</div>
				</div>
				<div data-fixed="">
					<div class="u-top-viewall">
